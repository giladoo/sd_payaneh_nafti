...
# ########################################################################################
class ReportSdPayanehNaftiLockerLogReport(models.AbstractModel):
    _name = 'report.sd_payaneh_nafti.locker_log_report_template'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        locker_logs = self.env['sd_payaneh_nafti.locker_logs'].search([('loading_date', '>=', first_day),
        ...
        # errors = ['test error']
        return {
            'docs': locker_logs[0] if locker_logs else '',
            'errors': errors,
            }
