...
class SdPayanehNaftiLoadingPlan(models.Model):
    ...
    plan_1 = fields.Integer(tracking=True)
    plan_2 = fields.Integer(tracking=True)
    plan_3 = fields.Integer(tracking=True)
    plan_4 = fields.Integer(tracking=True)
    plan_5 = fields.Integer(tracking=True)
    plan_6 = fields.Integer(tracking=True)
